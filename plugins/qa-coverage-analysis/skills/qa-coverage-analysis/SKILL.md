...
allowed-tools: Bash(ls:*), Bash(git:*), Bash(python3:*), Bash(curl:*), Bash(grep:*), Bash(find:*), Read, Grep, Glob, mcp__claude_ai_Atlassian__getJiraIssue, mcp__claude_ai_Atlassian__search, mcp__plugin_atlassian_atlassian__getJiraIssue, mcp__plugin_atlassian_atlassian__search, mcp__atlassian__getJiraIssue, mcp__atlassian__search
---
